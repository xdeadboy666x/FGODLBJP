...
-----END RSA PRIVATE KEY-----
    ...
    def Free_Gacha(self):
        ...
        self.builder_.AddParameter(
            "storyAdjustIds",
            "[31011,31111,31211,31311,31411,31511,31611,31711,31811,31911,32011,32111,32121,32131,32141,32151,32161,32171,32181,32191,32201,32211,32221,32231,32241,32251]",
        )
        self.builder_.AddParameter("selectBonusList", "")
        self.builder_.AddParameter("gachaId", str(gachaId))
    ...
    def topHome(self):
        ...
        time.sleep(2)
        self.Post(
            f"{fgourl.server_addr_}/externalPayment/reflect?_userId={self.user_id_}"
        )
        time.sleep(1)
        self.Post(
            f"{fgourl.server_addr_}/externalPayment/reflect?_userId={self.user_id_}"
